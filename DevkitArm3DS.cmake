...
if (WIN32)
    ...
    set(CMAKE_STRIP "${DEVKITARM}/arm-none-eabi-strip.exe")
    ...
    set(CMAKE_STRIP "${DEVKITARM}/bin/arm-none-eabi-strip")
...
if (WITH_PORTLIBS)
    set(CMAKE_FIND_ROOT_PATH ${DEVKITARM} ${DEVKITPRO}
            ${DEVKITPRO}/portlibs/3ds ${DEVKITPRO}/portlibs/armv6k devkitARM/lib/gcc/arm-none-eabi/9.1.0/)
else ()
    set(CMAKE_FIND_ROOT_PATH ${DEVKITARM} ${DEVKITPRO})
endif ()
